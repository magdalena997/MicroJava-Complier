...
public class Code {
  ...
  public static int inverse[]={ne, eq, ge, gt, le, lt}; //  maps op to the inverse of top
	...
	public static void report_info(String message, SyntaxNode info) {
		StringBuilder msg = new StringBuilder(message); 
		int line = (info == null) ? 0: info.getLine();
		if (line != 0)
			msg.append (" na liniji ").append(line);
  ...
  public static void load (Obj o) {
    switch (o.getKind()) {
      ...
      case Obj.Var:
    	  report_info("Pristup getstatic na stek. " , null);
      ...
      case Obj.Elem:
        ...
        else {put(aload); System.out.print(" Pristum elementu niza"); } 
        break;
