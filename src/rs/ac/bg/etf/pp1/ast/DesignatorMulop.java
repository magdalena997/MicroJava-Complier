...
public class DesignatorMulop extends DesignatorStatement {

    private Designator Designator;
    private MulopRight MulopRight;
    private Expr Expr;

    public DesignatorMulop (Designator Designator, MulopRight MulopRight, Expr Expr) {
