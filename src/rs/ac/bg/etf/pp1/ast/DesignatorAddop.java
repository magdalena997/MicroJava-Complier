...
public class DesignatorAddop extends DesignatorStatement {

    private Designator Designator;
    private AddopRight AddopRight;
    private Expr Expr;

    public DesignatorAddop (Designator Designator, AddopRight AddopRight, Expr Expr) {
